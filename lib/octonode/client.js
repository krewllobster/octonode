...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.errorHandlePromise = function(cb) {
      debugger;
      return function(arg) {
        var body, fiveHundredError, fourHundredError, headers, ref, statusCode;
        statusCode = arg.statusCode, (ref = arg.response, body = ref.body, headers = ref.headers);
        debugger;
    ...
    Client.prototype.successHandle = function(cb) {
      debugger;
      return function(arg) {
        var body, headers, statusCode;
        statusCode = arg.statusCode, body = arg.body, headers = arg.headers;
        debugger;
    ...
    Client.prototype.get = function() {
      ...
      return this.rp(options).then(this.successHandle(cb))["catch"](this.errorHandlePromise(cb));
    };
