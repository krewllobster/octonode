...
(function() {
  ...
  HttpError = (function(superClass) {
    ...
    function HttpError(message1, statusCode1, headers1, body1) {
  ...
  Client = (function() {
    function Client(token1, options1) {
      ...
      this.rp = this.options && this.options.request || request;
    ...
    Client.prototype.errorHandle = function(arg, body, cb) {
      var error, fiveHundredError, fourHundredError, headers, message, statusCode;
      statusCode = arg.statusCode, headers = arg.headers, message = arg.message, error = arg.error;
      ...
      if (cb) {
        return cb(null, res.statusCode, body, res.headers);
      }
    ...
    Client.prototype.get = function() {
      ...
      debugger;
      return this.request(options, (function(_this) {
        return function(err, res, body) {
          if (err) {
            ...
            debugger;
            return _this.errorHandle(res, body, cb);
          }
        };
      })(this));
    };
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          return _this.request(options, function(err, res, body) {
            ...
            return _this.errorHandle(res, body, resolve, reject, cb);
          });
        };
      })(this));
    };
